...
const Banner = () => {
  return (
  <section className='min-h-[80vh] lg:min-h-[70vh] flex
    ...
    <div className="container mx-auto">
      ...
      lg:items-center lg:gap-x-12'>
        ...
        <div className='flex-1 text-center font-secondary lg:text-left '>
          ...
          lg:text-[80px] '>
          Alina<span> Saqib</span>
        </motion.h1>
        <motion.div variants={fadeIn("up",0.4)} initial='hidden' 
          whileInView={'show'} viewport={{once: false, amount: 0.7 }} 
          className='mb-3 text-[30px] lg:text-[40px] 
        ...
        <motion.p variants={fadeIn("up",0.5)} initial='hidden' 
          whileInView={'show'} viewport={{once: false, amount: 0.7 }}
           className='mb-5 max-w-lg mx-auto lg:mx-0'>A passionate software engineer with a keen 
           eye for web development, shaping digital possibilities.
          </motion.p>
          ...
          className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
            <a href='https://www.linkedin.com/in/alinasaqib/' rel="noreferrer" target="_blank">
              <FaLinkedin/>
            </a>
            <a href='https://github.com/Alina-Saqib' rel="noreferrer" target="_blank">
             <FaGithub/>
            </a>
          </motion.div>
